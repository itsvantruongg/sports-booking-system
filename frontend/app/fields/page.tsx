...
export default function PublicFieldsPage() {
  ...
  useEffect(() => {
    ...
    if (q !== null) {
      setSearchText(q);
      // Optional: Auto-detect if q is a city
  ...
  useEffect(() => {
    // Trigger fetch when any filter changes, including those from URL
    fetchVenues();
    ...
    <div className="min-h-screen bg-surface-container-lowest text-on-surface">
      ...
      <main className="pt-12 pb-24 px-4 md:px-8 max-w-[1440px] mx-auto flex flex-col md:flex-row gap-8">
        ...
        <aside className="w-full md:w-80 flex-shrink-0">
          <div className="bg-surface-container-low rounded-2xl p-8 sticky top-32 shadow-sm border border-outline-variant/5">
        ...
        <div className="flex-1">
          <div className="flex justify-between items-end mb-8 flex-wrap gap-4">
            <div>
              <h1 className="text-4xl font-black tracking-tight text-on-surface mb-1" style={{ fontFamily: "Plus Jakarta Sans, sans-serif" }}>Tất cả sân</h1>
              <p className="text-on-surface-variant">Tìm kiếm và đặt các cụm sân tốt nhất.</p>
            </div>
