...
export default function UserFieldsDetailPage() {
  return (
...
<main className="max-w-[1440px] mx-auto px-4 md:px-8 grid grid-cols-1 lg:grid-cols-3 gap-12">
{/* Left Column: Details */}
...
<button className="py-2 px-1 rounded-md text-sm font-medium border border-outline-variant/30 text-outline-variant bg-surface-dim cursor-not-allowed">
                            16:00
                        </button>
...
{/* CTA */}
<a href="/user/book" className="w-full bg-gradient-to-br from-primary to-primary-container text-on-primary py-4 rounded-full font-display font-bold text-lg hover:shadow-lg transition-all active:scale-[0.98]" style={{ display: "block", textAlign: "center" }}>Book Now</a>
