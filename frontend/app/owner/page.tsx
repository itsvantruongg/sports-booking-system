    ...
    <div className="p-8 lg:p-12">
      ...
      <header className="flex justify-between items-end mb-12">
        <div>
          ...
          <h2 className="text-4xl md:text-5xl font-bold font-display tracking-tight text-on-surface">Good morning, Facility Admin</h2>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
        ...
        <div className="bg-surface-container-lowest p-6 rounded-xl shadow-[0_12px_40px_rgba(25,27,37,0.06)] relative overflow-hidden group">
          ...
          <div className="flex items-baseline gap-3">
            <span className="text-4xl font-bold font-display tracking-tighter text-on-surface">{stats.booking_count}</span>
          </div>
        </div>
        ...
        <div className="bg-surface-container-lowest p-6 rounded-xl shadow-[0_12px_40px_rgba(25,27,37,0.06)] relative overflow-hidden group border-b-4 border-green-500">
          ...
          <div className="flex items-baseline gap-3">
            <span className="text-4xl font-bold font-display tracking-tighter text-on-surface">{stats.revenue.toLocaleString('vi-VN')} ₫</span>
          </div>
        </div>
        ...
        <div className="bg-surface-container-lowest p-6 rounded-xl shadow-[0_12px_40px_rgba(25,27,37,0.06)] relative overflow-hidden group border-b-4 border-yellow-500">
          ...
          <div className="flex items-baseline gap-3">
            <span className="text-4xl font-bold font-display tracking-tighter text-on-surface text-yellow-700">{stats.debt.toLocaleString('vi-VN')} ₫</span>
          </div>
        </div>
        ...
        <div className="bg-surface-container-lowest p-6 rounded-xl shadow-[0_12px_40px_rgba(25,27,37,0.06)] relative overflow-hidden group">
          ...
          <div className="flex items-baseline gap-2">
            <span className="text-4xl font-bold font-display tracking-tighter text-on-surface">{stats.occupancy}</span>
