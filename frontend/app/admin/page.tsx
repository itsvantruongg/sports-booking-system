    ...
    <div className="p-6 lg:p-12">
      <header className="flex justify-between items-end mb-12">
        <div>
          ...
          <h2 className="text-4xl md:text-5xl font-headline font-extrabold tracking-tight text-primary">Bảng điều khiển Tổng</h2>
        </div>
        ...
        <div className="lg:col-span-4 bg-surface-container-low p-8 rounded-lg lg:row-span-2 flex flex-col">
          ...
          <div className="flex flex-col gap-4 flex-grow">
            {[
              ...
              { href: "/admin/add-partner", icon: "person_add", color: "text-blue-600 bg-blue-100 group-hover:bg-blue-200", label: "Thêm Đối tác mới", sub: "Thêm chủ sân vào hệ thống" },
              ...
              <Link key={item.href} href={item.href}
                className="bg-surface-container-lowest p-4 rounded-xl flex items-center gap-4 hover:shadow-[0_12px_40px_rgba(25,27,37,0.06)] transition-all cursor-pointer group border border-outline-variant/5">
